...
<div class="row">
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='_basic'> {sugar_translate label='' module='OAuth2Tokens'}</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
		
{if strlen($fields._basic.value) <= 0}
{assign var="value" value=$fields._basic.default_value }
{else}
{assign var="value" value=$fields._basic.value }
{/if}  
<input type='text' name='{$fields._basic.name}' 
    id='{$fields._basic.name}' size='30' 
