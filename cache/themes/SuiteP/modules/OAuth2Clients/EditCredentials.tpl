...
{sugar_translate label='DEFAULT' module='OAuth2Clients'}
</div>
</a>
</div>
...
<div class="col-xs-12 col-sm-12 edit-view-row-item" data-field="new_secret">


<div class="col-xs-12 col-sm-2 label" data-label="">

{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_SECRET_HASHED' module='OAuth2Clients'}{/capture}
{$label|strip_semicolon}:
...
{counter name="panelFieldCount"  print=false}
<input tabindex="0"  type="password" name="new_secret" id="new_secret" placeholder="{$MOD.LBL_LEAVE_BLANK}" size="30"><input tabindex="0"  type="hidden" name="allowed_grant_type" id="allowed_grant_type" value="client_credentials"><br /><span>{$MOD.LBL_REMEMBER_SECRET}</span>
</div>
...
<div class="col-xs-12 col-sm-12 edit-view-row-item" data-field="is_confidential">
...
{/if}
<input type="hidden" name="{$fields.is_confidential.name}" value="0"> 
<input type="checkbox" id="{$fields.is_confidential.name}" 
name="{$fields.is_confidential.name}" 
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_USER' module='OAuth2Clients'}{/capture}
{$label|strip_semicolon}:
...
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditCredentials","field_to_name_array":{"id":"assigned_user_id","user_name":"assigned_user_name"}}{/literal}, 
"single", 
true
...
YAHOO.util.Event.onContentReady("EditCredentials",
    function () {ldelim} initEditView(document.forms.EditCredentials) {rdelim});
