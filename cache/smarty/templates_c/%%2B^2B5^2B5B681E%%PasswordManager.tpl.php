<?php /* Smarty version 2.6.33, created on 2022-05-23 20:10:07
         compiled from modules/Administration/PasswordManager.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_help', 'modules/Administration/PasswordManager.tpl', 72, false),array('function', 'sugar_getimagepath', 'modules/Administration/PasswordManager.tpl', 682, false),)), $this); ?>
...
$this->_smarty_include(array('smarty_include_tpl_file' => "modules/Administration/PasswordManagerSecurity.tpl", 'smarty_include_vars' => array()));
...
">
							...
							<tr>
								<td  scope="row"><?php echo $this->_tpl_vars['MOD']['LBL_TWO_FACTOR_AUTH_EMAIL_TPL']; ?>
: </td>
								<td>
									<span>
										<select tabindex='251' id="factoremailtmpl"
                                                name="passwordsetting_factoremailtmpl" <?php echo $this->_tpl_vars['IE_DISABLED']; ?>
><?php echo $this->_tpl_vars['TMPL_DRPDWN_FACTOR']; ?>
</select>
...
" class="button"
                                               ...
                                               style="<?php echo $this->_tpl_vars['EDIT_TEMPLATE']; ?>
">
									</span>
                        </td>
								<td ></td>
...
> </td>
						             ...
						             <!-- start SAML -->
                            <?php if (! empty ( $this->_tpl_vars['config']['authenticationClass'] ) && ( $this->_tpl_vars['config']['authenticationClass'] == 'SAMLAuthenticate' || $this->_tpl_vars['config']['authenticationClass'] == 'SAML2Authenticate' )): ?>
