<?php /* Smarty version 2.6.33, created on 2022-05-20 07:44:28
         compiled from cache/themes/SuiteP/modules/OAuth2Tokens/SearchForm_basic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteP/modules/OAuth2Tokens/SearchForm_basic.tpl', 31, false),array('function', 'math', 'cache/themes/SuiteP/modules/OAuth2Tokens/SearchForm_basic.tpl', 32, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/OAuth2Tokens/SearchForm_basic.tpl', 38, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteP/modules/OAuth2Tokens/SearchForm_basic.tpl', 64, false),)), $this); ?>
...
<div class="row">
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='_basic'> <?php echo smarty_function_sugar_translate(array('label' => '','module' => 'OAuth2Tokens'), $this);?>
</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
		
<?php if (strlen ( $this->_tpl_vars['fields']['_basic']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['_basic']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['_basic']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['_basic']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['_basic']['name']; ?>
' size='30' 
