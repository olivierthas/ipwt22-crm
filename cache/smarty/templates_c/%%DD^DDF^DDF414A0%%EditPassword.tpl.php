<?php /* Smarty version 2.6.33, created on 2022-05-20 07:43:40
         compiled from cache/themes/SuiteP/modules/OAuth2Clients/EditPassword.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'cache/themes/SuiteP/modules/OAuth2Clients/EditPassword.tpl', 47, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/OAuth2Clients/EditPassword.tpl', 102, false),array('function', 'sugar_include', 'cache/themes/SuiteP/modules/OAuth2Clients/EditPassword.tpl', 63, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/OAuth2Clients/EditPassword.tpl', 84, false),array('function', 'counter', 'cache/themes/SuiteP/modules/OAuth2Clients/EditPassword.tpl', 109, false),array('block', 'minify', 'cache/themes/SuiteP/modules/OAuth2Clients/EditPassword.tpl', 100, false),)), $this); ?>
...
" class="button primary" onclick="var _form = document.getElementById('EditPassword'); <?php if ($this->_tpl_vars['isDuplicate']): ?>_form.return_id.value=''; <?php endif; ?>_form.action.value='Save'; if(check_form('EditPassword'))SUGAR.ajaxUI.submitForm(_form);return false;" type="submit" name="button" value="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_LABEL']; ?>
" id="SAVE"><?php endif; ?> 
...
" size="30" autocomplete="dont-fill-this-password"><input tabindex="0"  type="hidden" name="allowed_grant_type" id="allowed_grant_type" value="password"><br /><span><?php echo $this->_tpl_vars['MOD']['LBL_REMEMBER_SECRET']; ?>
</span>
</div>
...
YAHOO.util.Event.onContentReady("EditPassword",
    function () { initEditView(document.forms.EditPassword) });
