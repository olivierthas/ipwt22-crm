...
$hook_array['after_save'][] = Array(31, 'updateIntegrationProject', 'custom/modules/IntegrationProjectProxy.php','IntegrationProjectProxy', 'sendMessage');
...
$hook_array['after_delete'][] = Array(2, 'deleteIntegrationProject', 'custom/modules/IntegrationProjectProxy.php','IntegrationProjectProxy', 'sendDeleteMessage');
